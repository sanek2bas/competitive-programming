...
/// and printNumber that prints a given integer to the console.
...
public class FizzBuzz
{
    ...
    private readonly SemaphoreSlim fizzSemaphore;
    private readonly SemaphoreSlim buzzSemaphore;
    private readonly SemaphoreSlim fizzbuzzSemaphore;
    private readonly SemaphoreSlim numberSemaphore;

    public FizzBuzz(int n) 
    {
        this.n = n;
        fizzSemaphore = new SemaphoreSlim(0);
        buzzSemaphore = new SemaphoreSlim(0);
        fizzbuzzSemaphore = new SemaphoreSlim(0);
        numberSemaphore = new SemaphoreSlim(1);
    }
